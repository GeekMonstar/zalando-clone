            ...
            <div className="flex justify-between items-center">
                ...
                <ul className="w-full justify-end flex items-center gap-3">
                    ...
                    <li className="relative">
                        ...
                        <Link className="absolute top-0 left-0 w-full h-full z-index-5" href="/myaccount"></Link>
                    </li>
                    <li className="relative">
                        ...
                        <Link className="absolute top-0 left-0 w-full h-full z-index-5" href="/wishlist"></Link>
                    </li>
                    <li className="relative">
